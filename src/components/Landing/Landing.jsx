  ...
  return (
    <>
      ...
      <div className="relative flex flex-col items-center justify-center w-screen h-screen overflow-hidden bg-black">
        <svg className='absolute h-screen w-[99vw] -z-10 mt-5 block overflow-hidden' width="100vw" overflow="hidden" height="100%" viewBox='0 0 1903 1058' fill="none" preserveAspectRatio='none' xmlns="http://www.w3.org/2000/svg">
